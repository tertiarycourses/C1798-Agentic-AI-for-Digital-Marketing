...
# Use an isolated LibreOffice profile for this build. A shared desktop profile
# can leave a background soffice process holding conversion locks on Windows.
LO_PROFILE_DIR="${TMPDIR:-/tmp}/nonwsq-lo-$$"
...
LO_PROFILE_URI="file:///$LO_PROFILE_PATH"
